...
namespace AriBotV4.Dialogs
{
    public class BugReportDialog : ComponentDialog
    {
        ...
        private async Task<DialogTurnResult> SummaryStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            userProfile.Subject = (string)stepContext.Values["description"];
            ...
            await stepContext.Context.SendActivityAsync(MessageFactory.Text(String.Format("Description: {0}", userProfile.Subject)), cancellationToken);
